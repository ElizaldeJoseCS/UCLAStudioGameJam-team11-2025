...
public class CursorLevelThree : MonoBehaviour
{
    [SerializeField] public int numTargets = 10;
    [SerializeField] public float cursorSpeed = 1.3f;
    ...
    {
        return (numHits) >= numTargets;
    }

    public bool winGame()
    {
        // need at least 80% hits to win
        // equal to or less than 2 misses allowed
        return numMisses <= 2f;
    }
}
